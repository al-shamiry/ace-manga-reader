...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::library::set_mangas_categories,
            commands::library::remove_mangas_from_library,
            commands::library::remove_mangas_from_category,
            commands::reader::list_chapters,
            commands::reader::rescan_manga,
            commands::reader::open_chapter,
            commands::reader::set_chapter_progress,
            commands::reader::set_mangas_read,
            commands::reader::set_chapters_read,
